...
public class Dice {
     ...
     * @return an array whose with element contains the number of times the 
     * value i occurred in the input. The 0 element is unused. 
     */
    public static int[] countInputs(int sides)
    {
       int[] counters = new int[sides + 1]; // 0] is not used
       
       System.out.println("Please enter your values, Q to quit:");
