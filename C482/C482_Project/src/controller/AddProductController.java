...
public class AddProductController<Product> implements Initializable {
    ...
    private void saveAddProduct(MouseEvent event
        ...
        double minCost = 0;
        for (int i = 0; i < assocPartList.size(); i++) {
            minCost += assocPartList.get(i).getPartPrice();
        }
    ...
    private void saveProduct() {
       ...
       model.Product product = new model.Product(Integer.parseInt(id.getText().trim()), name.getText().trim(),
        ...
        inv.addProduct((model.Product) product);
